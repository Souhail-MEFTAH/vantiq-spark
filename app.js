...
async function loadSampleUseCase(sampleId) {
    ...
    if (window.Renderers) {
        ...
        if (state.results.competitive) { Renderers.renderCompetitiveAnalysis(state.results.competitive, document.getElementById('competitive-content')); enableNav('competitive'); }
        ...
        if (state.results.agenticGuide) { Renderers.renderAgenticGuide(state.results.agenticGuide, document.getElementById('agentic-content')); enableNav('agentic'); }
