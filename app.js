...
function getCoachPanelMap() {
    ...
    const maps = {
        ...
        ko: {
            ...
            agentic: { contextKey: 'agentic', label: '에이전틱 AI 가이드', suggestions: ['AI 에이전트란 무엇이며 일반 모델과 어떻게 다른가요?', '이 에이전트들은 어떻게 상호 작용하나요?', '에이전트는 어떤 도구를 사용하나요?'] },
        ...
        ja: {
            ...
            agentic: { contextKey: 'agentic', label: 'エージェントAIガイド', suggestions: ['AIエージェントとは何ですか？モデルとどう違うのですか？', 'これらのエージェントはどのように連携しますか？', 'エージェントはどのようなツールを使用しますか？'] },
        ...
        ar: {
            ...
            agentic: { contextKey: 'agentic', label: 'دليل الذكاء الاصطناعي الوكيل', suggestions: ['ما هو وكيل الذكاء الاصطناعي وكيف يختلف عن النموذج العادي؟', 'كيف تنسق هذه الوكالات مع بعضها البعض؟', 'ما هي الأدوات والقدرات التي تمتلكها هذه الوكالات؟'] },
