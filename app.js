...
const I18N = {
    en: {
        ...
        "nav-agentic": "Solution Architecture",
        ...
        "agentic-title": "Solution Architecture",
        "agentic-subtitle": "Agent 4b — Hybrid Deterministic & AI Guide",
        ...
        "pdf-sec-agentic": "6. Solution Architecture (Hybrid)",
        ...
        "reg-agentic": "Agent 4b — Solution Arch",
    ...
    ko: {
        ...
        "agentic-title": "솔루션 아키텍처",
        "agentic-subtitle": "에이전트 4b — 하이브리드 자동화 가이드",
        ...
        "pdf-sec-agentic": "6. 하이브리드 솔루션 아키텍처",
    ...
    ja: {
        ...
        "agentic-title": "ソリューションアーキテクチャ",
        "agentic-subtitle": "エージェント 4b — ハイブリッド自動化ガイド",
        ...
        "pdf-sec-agentic": "6. ハイブリッドソリューションアーキテクチャ",
    ...
    ar: {
        ...
        "nav-agentic": "بنية الحل والهيكلة",
        ...
        "agentic-title": "بنية الحل والهيكلة",
        "agentic-subtitle": "الوكيل 4ب — دليل أتمتة الأنظمة الهجينة",
        ...
        "pdf-sec-agentic": "6. بنية الحل الهجينة (Hybrid)",
        ...
        "reg-agentic": "الوكيل 4ب — بنية الحل",
...
function getCoachPanelMap() {
    ...
    const maps = {
        en: {
            ...
            agentic: { contextKey: 'agentic', label: 'Solution Architecture', suggestions: ["Why did you choose a deterministic approach here?", "How much token cost does this hybrid approach save?", "When should we use an AI Agent over a standard rule?"] },
        ...
        ko: {
            ...
            agentic: { contextKey: 'agentic', label: '솔루션 아키텍처', suggestions: ['여기에 결정론적 접근 방식을 선택한 이유는 무엇인가요?', '이 하이브리드 접근 방식은 토큰 비용을 얼마나 절감하나요?', '언제 일반 규칙 대신 AI 에이전트를 사용해야 하나요?'] },
        ...
        ja: {
            ...
            agentic: { contextKey: 'agentic', label: 'ソリューションアーキテクチャ', suggestions: ['ここで決定論的アプローチを選んだ理由は何ですか？', 'このハイブリッドアプローチでトークンコストはどのくらい削減できますか？', '標準ルールの代わりにAIエージェントを使用すべきなのはいつですか？'] },
        ...
        ar: {
            ...
            agentic: { contextKey: 'agentic', label: 'بنية الحل والهيكلة', suggestions: ['لماذا اخترت النهج الحتمي أو البرمجة التقليدية هنا؟', 'ما مقدار تكلفة الرموز (Tokens) التي يوفرها هذا النهج الهجين؟', 'متى يجب أن نستخدم وكيل الذكاء الاصطناعي بدلاً من القاعدة القياسية؟'] },
